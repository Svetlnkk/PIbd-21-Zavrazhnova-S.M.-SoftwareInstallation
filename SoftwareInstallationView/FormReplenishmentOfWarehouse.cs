...
{
    public partial class FormReplenishmentOfWarehouse : Form
    {
        ...
        public FormReplenishmentOfWarehouse(IWarehouseLogic logicWarehouse, IComponentLogic logicComponent)
        {
            InitializeComponent();
